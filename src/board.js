class Board {
  ...
  constructor() {
    this.grid = grid;
    this.grid[1][7] = { color: "grey", points: 100, bonus: "" };
    ...
    this.grid[2][2] = { color: "grey", points: 100, bonus: "" };
    this.grid[2][3] = { color: "grey", points: 100, bonus: "" };
    this.grid[2][4] = { color: "grey", points: 100, bonus: "" };
    ...
    this.grid[3][21] = { color: "black", points: -200 };
    ...
    this.grid[13][12] = { color: "grey", points: 100, bonus: "" };
    ...
    this.grid[13][19] = { color: "grey", points: 100, bonus: "" };
